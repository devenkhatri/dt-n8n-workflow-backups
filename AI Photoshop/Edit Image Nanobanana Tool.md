...
## Description
This workflow edits an image using the Nano-Banana AI model based on a text prompt. It retrieves the original image from Google Drive, processes it through an AI service, and saves the edited result back to Google Drive with a shareable link.
