...
## Description
This workflow uses the Nano-Banana AI model to edit an image based on a text prompt. It retrieves an image from Google Drive, processes it through an AI image editing service, and saves the result back to Google Drive with a shareable link.
