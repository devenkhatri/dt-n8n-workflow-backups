...
## Description
This workflow uses the Nano-Banana AI model to edit an image based on a text prompt. It fetches the original image from Google Drive, processes it with AI, and saves the edited version back to Google Drive with a shareable link.
